...
public class ManagerCartasModoC1 : MonoBehaviour
{
    ...
    void AddUmaCarta(int linha, int rank, int valor)
    {
        ...
        GameObject.Find("" + linha + "_" + valor).GetComponent<TileModoC1>().setCartaOriginal(s1, linha);
    }
    ...
    public void CartaSelecionada(GameObject carta)
    {
        if (!primeiraCartaSelecionada)
        {
            ...
            carta1 = carta;
            carta1.GetComponent<TileModoC1>().RevelaCarta();
        }
        else if (primeiraCartaSelecionada && !segundaCartaSelecionada)
        {
            ...
            primeiraCartaSelecionada = true;
            carta2 = carta;
            carta2.GetComponent<TileModoC1>().RevelaCarta();
            VerificaCartas();
        }
    }
